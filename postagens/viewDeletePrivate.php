        ...
        <main class="pure-u-1 pure-u-lg-18-24" id="posts-container">
            ...
            <form name="produto" action="deletePost.php?slug=<?php echo $slug; ?>" class="form border rounded shadow-lg" method="post" enctype="multipart/form-data">
				...
				<div class="espaco_criacao">
					...
					<?php if ($isVideo): ?>
						<video class="video-post" width="600" controls readonly>
					...
					<div class="d-grid col-md-9">
						...
						<a href="privados.php"><button class="btn btn-outline-danger" type="button" title="Voltar" style="color: 444;"><i class="fa-solid fa-rotate-left"></i> Cancelar</button></a>
					</div>
				</div>
				<br><br><br><br><br><br>
            </form>
