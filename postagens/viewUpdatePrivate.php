        ...
        <main class="pure-u-1 pure-u-lg-18-24" id="posts-container">
            ...
            <form name="produto" action="alterarPost.php?slug=<?php echo $slug; ?>" class="form border rounded shadow-lg" method="post" enctype="multipart/form-data">
				...
				<div class="espaco_criacao">
					...
					<?php else: ?>
						<img src="<?php echo $foto ?>" alt="Foto do Post" class="image-post" id="imgPreview">
					<?php endif; ?>
					</div>
					<br>
					...
					<div class="col ">
						<b>Título do Post:</b><br><input class="form-control border-primary" placeholder="Digite o Título" type="text" name="titulo" id="titulo" maxlength="80" title="Digite o Título" value="<?php echo $post['pos_Titulo']; ?>">
					</div><br>

					<div class="col form-control">
						<b>Conteudo do Post:</b><br>
						<textarea name="assuntoCompleto" id="assuntoCompleto">
						<?php echo $post['pos_Conteudo']; ?>
						</textarea>
						<br>
					</div>
					<br>
