...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $nomeDigitado = isset($_POST['nome']) ? $_POST['nome'] : null;

            if ($perfil === null) {
                die('Perfil não especificado.');
            }

            // Verifique se o nome digitado é o mesmo nome na sessão antes de prosseguir com a exclusão
            if ($nomeDigitado !== $_SESSION['nome']) {
                header('Location: perfilView.php');
                $_SESSION['message'] = "Nome digitado não é o mesmo do usuário!";
                exit;
            }
            ...
            $perfil_nome = $perfilRow['use_Nome'] ?? null;
